...
public class BlockMatrixMultiply {
    ...
    // 1. How many types do we need to have? -> 2 tasks -> a multiply task, and a
    // sum task
    // 2. How can we identify the blocks that we need to multiply?
    // 3. How can we synchronize the multiplication and sum tasks?
    // 4. How can we identify the place where the block should be written in the
    // final matrix?
    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       // printMatrix(B);
        ...
        System.out.println("Execution time = " + (double)(end - start)/1_000_000_000);
       // System.out.println("");
       // printMatrix(C);
    }
