...
public class ThreadPoolExecutor6 {
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(
                ...
                // Interface RejectedExecutionHandler handler
        ...
        // rejected from java.util.concurrent.ThreadPoolExecutor@42a57993[Running, pool
        // size = 3, active threads = 3, queued tasks = 2, completed tasks = 0]
    }
